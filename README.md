...
10. [Futuras Etapas](#futuras-etapas)
...
- Modelos predeterminados utilices para la elaboración del espacio.
...
- Hubo exportaciones de imágenes creadas con IA para decorar y algunos otros elementos de modelado descargado de páginas que brindan esa facilidad como lo es sketchfab. [Sketchfab](https://sketchfab.com/tags/modelos)
- Cuenta con habitaciones que simulan entrar a otra dimensión. Funcionando gracias a que se colocó una skybox con el paisaje que conecta con la entrada a la habitación, simulando así que al cruzar un marco de puerta entraste a otro mundo totalmente observable desde todos los dispositivos.
- Cuentan con sonido de fondo alusivo a cada paisaje.
- Dentro del mapa hay una actividad didáctica, pensada para cuando entren muchas personas al mismo tiempo. Consiste en un rompecabezas con piezas que está disperso por todo el mapa, los jugadores deben encontrarlas y armarlas basándose en una imagen que decora una pared.

## Imágenes del proyecto

*(Aquí puedes colocar imágenes representativas de tu proyecto)*
...
2. **Problemas de optimización en ciertos dispositivos.**
3. **Limitaciones en la exportación de skyboxes de manera convencional:** Requirió la creación del mapa en otro programa y su posterior exportación completa en Spatial.
...
- Empezar los proyectos desde Unity, para mayor versatilidad a la hora de querer agregar o quitar objetos de una manera más sencilla.
